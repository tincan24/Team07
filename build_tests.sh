...
case `uname` in
  Linux)
    ...
    g++ -std=c++0x -isystem ${GTEST_DIR}/include -pthread server_test.cpp reply_test.cpp reply.cpp server.cpp -lboost_system ${GTEST_DIR}/src/gtest_main.cc libgtest.a -o reply_test ;;
  Darwin)
